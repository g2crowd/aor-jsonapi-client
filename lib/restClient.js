...
function createIncludedMap(_ref) {
  ...
  return (json.included || []).reduce(function (accumulator, value) {
    ...
    accumulator[type][id] = Object.assign({ id: id, type: type }, attributes);
    return accumulator;
  }, {});
}
...
function denormalize(_ref2, included) {
  ...
  var attributes = included[type] && included[type][id] || {};
  return Object.assign({ id: id, type: type }, attributes);
}
