...
exports.default = function (apiUrl) {
  ...
  var convertRESTRequestToHTTP = function convertRESTRequestToHTTP(type, resource, params) {
    ...
    var _ref3 = params.filter || {},
        include = _ref3._include,
        filter = _objectWithoutProperties(_ref3, ['_include']);
    ...
    var custom = function custom() {
      ...
      var path = member ? apiUrl + '/' + resource + '/' + id + '/' + action : apiUrl + '/' + resource + '/' + action;
      return {
        url: path, options: { method: method, body: JSON.stringify({ data: data }) }
      };
    };
    ...
    var _ref5 = (converters[type] || converters.fallback)(),
        url = _ref5.url,
  ...
  var convertHTTPResponseToREST = function convertHTTPResponseToREST(response, type) {
    ...
    var denormalize = function denormalize(_ref6) {
      var json = _ref6.json;
